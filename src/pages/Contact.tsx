...
import { FaFacebookF, FaInstagram, FaPhoneVolume, FaPinterestP } from "react-icons/fa6";
      ...
      <div className="relative h-[40vh] md:h-[50vh] w-full overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="mt-6 text-white/90 max-w-xl text-center text-sm md:text-base drop-shadow-md font-medium">
             Whether you have a question about our jewelry, need styling advice, or want to share your feedback, we're here to help.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="name" placeholder="Your full name" className="bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 h-12" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="email">Email</Label>
                  <Input id="email" type="email" placeholder="your@email.com" className="bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 h-12" />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="subject">Subject</Label>
                <Input id="subject" placeholder="What is this regarding?" className="bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 h-12" />
              </div>
          ...
          <div className="space-y-12 lg:pl-12 pt-8">
            <div>
              ...
              <p className="text-muted-foreground mb-8">Visit our boutique or reach out through any of the channels below.</p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      123 Luxury Avenue Madison<br />
                      Square, New York, 10010 United<br />
                      States
                    </p>
                  </div>
                </div>
            ...
            <div className="border-t border-gray-200 dark:border-gray-800 pt-8">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-[#D4AF37] text-white flex items-center justify-center hover:bg-[#C5A028] transition-colors">
       ...
       <div className="pb-16 px-4 container mx-auto">
        <div className="text-center mb-10">
            <h2 className="text-3xl font-serif font-bold mb-2">Find Our Boutique</h2>
            <p className="text-muted-foreground">Located in the heart of Madison Square, New York</p>
        </div>
