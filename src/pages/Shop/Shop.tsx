...
const Shop = () => {
  ...
  return (
    <div className="dark:bg-gray-900/95">
      ...
      <div className="flex gap-6 px-4 md:px-8 lg:px-20 py-8">
        {/* Sidebar */}
        <aside className="w-full md:w-64 lg:w-72 shrink-0 space-y-6">
          <div className="border border-gray-200 rounded-lg p-6 bg-white flex flex-col items-center ">
            <Box />
          </div>
          <div className="border border-gray-200 rounded-lg p-6 bg-white flex flex-col items-center ">
            <Slide />
          ...
          <div className="border border-gray-200 rounded-lg p-6 bg-white">
            ...
            <div className="flex flex-col gap-3">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded" />
                <span className="text-sm text-gray-700">Leather</span>
              </label>
            </div>
          </div>
        </aside>
