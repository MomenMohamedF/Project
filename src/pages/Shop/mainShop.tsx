    ...
    return (
        <div className="dark:bg-gray-900 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <h1 className="text-4xl font-bold text-center mb-4 dark:text-white">Our Collections</h1>
                <p className="text-xl text-center text-gray-600 dark:text-gray-300 mb-12">Select a category to start shopping</p>
